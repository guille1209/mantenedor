            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading">{{ trans('ui.ip.new_ip') }}</div>
                        <div class="panel-body">
                            @include('errors.form_error')

                            {!! Form::open(array('url' => '/ip', 'class' => 'cmxform form-horizontal', 'id' => 'nameForm')) !!}

                            @include('ip.form', ['button' => trans('ui.ip.button_add'), 'cancel' => trans('ui.ip.button_cancel')])
