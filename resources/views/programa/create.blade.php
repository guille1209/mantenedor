            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading">{{ trans('ui.programa.new_programa') }}</div>
                        <div class="panel-body">
                            @include('errors.form_error')

                            {!! Form::open(array('url' => '/programa', 'class' => 'cmxform form-horizontal', 'id' => 'nameForm')) !!}

                            @include('programa.form', ['button' => trans('ui.programa.button_add'), 'cancel' => trans('ui.programa.button_cancel')])
