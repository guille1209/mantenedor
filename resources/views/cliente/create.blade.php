            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default">
                        <div class="panel-heading">{{ trans('ui.cliente.new_cliente') }}</div>
                        <div class="panel-body">
                            @include('errors.form_error')

                            {!! Form::open(array('url' => '/cliente', 'class' => 'cmxform form-horizontal', 'id' => 'nameForm')) !!}

                            @include('cliente.form', ['button' => trans('ui.cliente.button_add'), 'cancel' => trans('ui.cliente.button_cancel')])
